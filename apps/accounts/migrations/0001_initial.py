    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('donor', 'Donor'), ('recipient', 'Recipient'), ('both', 'Both')], default='both', max_length=16)),
                ...
                ('avatar_file_id', models.PositiveIntegerField(blank=True, null=True)),
